...
* 외부와 히트싱크 경계면의 열전달계수(Heat Transfer Coefficient)는, 여기서는 10[W/m^2K]을 부여하였다.  일반적으로 자연대류 상태일 때는 10~25 가량을 주고, 냉각팬을 사용한 강제대류일때는 25~250 정도까지 올려주면 실제와 유사한 결과를 얻을 수 있다.
